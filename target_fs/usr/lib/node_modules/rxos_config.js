(function (fs, net, xml2js, child_process) {
  ...
  module.exports.getTunerConf = function(args, callback) {
...
})(require('fs'), require('net'), require('xml2js'), require('child_process'));
